    ...
    updateOrderBooks: function () {
        ...
        ExchangeContract.deployed().then(function(instance) {
            ...
            for(var i = 0; i < sellOrderBook[0].length; i++) {
                ...
                document.getElementById("sellOrderBook").innerHTML += '<div>Sell Tokens '+sellOrderBook[1][i]+' --> '+sellOrderBook[0][i]+' Wei</div>'; //sell 650@5000: sell 650 token for 5000 wei.
            }
            ...
            for(var i = 0; i < buyOrderBook[0].length; i++) {
                document.getElementById("buyOrderBook").innerHTML += '<div>Buy Tokens '+buyOrderBook[1][i]+' --> '+buyOrderBook[0][i]+' Wei</div>'; //sell 650@5000: sell 650 token for 5000 wei.
            }
        }).catch(function(e) {
            console.log(e);
            App.setStatus("Error getting balance -- see log.");
